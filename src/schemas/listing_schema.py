...
class ListingSchema(pa.DataFrameModel):
    ...
    accommodates: Series[float] = pa.Field(nullable=True, ge=1, coerce=True)
    ...
    minimum_nights: Series[float] = pa.Field(nullable=True, ge=1, coerce=True)
    maximum_nights: Series[float] = pa.Field(nullable=True, ge=1, coerce=True)
    minimum_minimum_nights: Series[float] = pa.Field(nullable=True, ge=1, coerce=True)
    maximum_minimum_nights: Series[float] = pa.Field(nullable=True, ge=1, coerce=True)
    minimum_maximum_nights: Series[float] = pa.Field(nullable=True, ge=1, coerce=True)
    maximum_maximum_nights: Series[float] = pa.Field(nullable=True, ge=1, coerce=True)
    ...
    number_of_reviews: Series[float] = pa.Field(nullable=True, ge=0, coerce=True)
    ...
    availability_30: Series[float] = pa.Field(nullable=True, ge=0, le=30, coerce=True)
    availability_60: Series[float] = pa.Field(nullable=True, ge=0, le=60, coerce=True)
    availability_90: Series[float] = pa.Field(nullable=True, ge=0, le=90, coerce=True)
    availability_365: Series[float] = pa.Field(nullable=True, ge=0, le=365, coerce=True)
    ...
    amenities: Series[str] = pa.Field(nullable=True, coerce=True)
